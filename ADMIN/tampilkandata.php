...
<div class="container">
	...
	<div class="row" style="background-color: rgba(0,0,0, 0.5); border-radius: 25px;">
		<div class="col-sm-1-offset col-sm-11 table-responsive text-center" >
			<table class="table table-bordered" style="width: 75%;background-color: white;">
				<thead>
					<tr>
					...
					?>
						<!-- <tr>
							...
							<td>
								...
								echo round($rata2_xab);
								?>
							</td>
							<td>
								<?php 
								$rata2_yab = $jumlah_yab / $xab;
								echo round($rata2_yab);
								?>
							</td>
							<td colspan="3"></td>
							...
							<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-body">
											<br>
											Prediksi golongan darah A untuk <?=$bulan;?> bulan berikutnya adalah <?=round($prediksia);?> <br>
											Prediksi golongan darah B untuk <?=$bulan;?> bulan berikutnya adalah <?=round($prediksib);?> <br>
											Prediksi golongan darah AB untuk <?=$bulan;?> bulan berikutnya adalah <?=round($prediksiab);?> <br>
											Prediksi golongan darah O untuk <?=$bulan;?> bulan berikutnya adalah <?=round($prediksio);?> <br>
											<button type="button" class="btn btn-danger" data-dismiss="modal" aria-label="Close">Oke</button>
										</div>
									</div>
								</div>
				...
				<div class="modal-content">
					<div class="modal-body">
						<form action="tampilkandata.php" method="post" style="text-align: center">
							<br>
							<label>Prediksi darah </label>
							<input type="number" name="n" style="width: 10%; "> 
							<label>bulan selanjutnya</label>
							<br>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-body">
						<form action="tampilkandata.php" method="post" style="text-align: center">
							<br>
							<label>Bulan tidak Sesuai </label>
						</form>
					</div>
				</div>
			</div>
